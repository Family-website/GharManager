...
(function applyAppleUI() {
    ...
    window.applyTheme = function(theme, isLoad = false) {
        ...
        if(!isLoad) {
            ...
            // Page load par bina popup ke store close karein
            if(typeof closeThemeStore === 'function') closeThemeStore();
        }
    };

    // Restore saved theme
    const saved = localStorage.getItem('appTheme');
    if(saved && saved !== 'default') window.applyTheme(saved, true);
})();
