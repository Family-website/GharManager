...
function checkRole(name) { 
    ...
    if(n.includes('aditya') || n.includes('papa')) { userRole = 'Admin'; let b = document.getElementById('role-badge'); if(b){ b.innerHTML = '<i class="fa-solid fa-crown"></i> Admin'; b.style.background = '#fef08a'; b.style.color = '#b45309'; } }
    else { userRole = 'Member'; let b = document.getElementById('role-badge'); if(b){ b.innerHTML = '<i class="fa-solid fa-user"></i> Member'; b.style.background = '#e2e8f0'; b.style.color = '#475569'; } }
    renderIcons();
}
...
function openProfile() {
    try {
        ...
        const lvlBadge = document.getElementById('profile-level-badge'); if(lvlBadge) { let level = Math.floor((parseInt(userXP) || 0) / 100) + 1; let title = level < 3 ? "Beginner" : level < 6 ? "Pro Saver" : "Finance Ninja"; lvlBadge.innerHTML = `<i class="fa-solid fa-medal"></i> Level ${level} | ${title} (XP: ${userXP})`; }
