...
function openThemeStore() { const tm = document.getElementById('theme-modal'); if(tm) tm.style.display = 'flex'; playSound('click'); }
...
// applyTheme already defined, saved theme applied at boot
})();
