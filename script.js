        ...
        html: `<div style="text-align:center;">
            ...
            <div style="background:linear-gradient(135deg,#eff6ff,#dbeafe); border:1.5px solid #93c5fd; border-radius:14px; padding:12px; margin-bottom:16px; display:flex; align-items:center; gap:10px;">
                <div style="flex:1; overflow:hidden;">
                    <p style="font-size:10px; color:#1d4ed8; font-weight:800; text-transform:uppercase; margin-bottom:3px;">App Link</p>
                    <p style="font-size:11px; color:#1e40af; font-weight:700; word-break:break-all; text-align:left; margin:0;">${GHARMANAGER_APP_URL}</p>
                </div>
                <button onclick="copyAppLink()" style="background:#2563eb; color:white; border:none; padding:8px 12px; border-radius:10px; font-size:11px; font-weight:800; cursor:pointer; flex-shrink:0;">Copy 🔗</button>
            </div>
