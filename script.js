...
// ============================================================
// ✨ FEATURE 3: CINEMATIC SPLASH ANIMATION CONTROLLER
// ============================================================
(function initSplashAnimation() {
    ...
    // Override hideSplash to add exit animation
    const _origHideSplash = window.hideSplash;
    window.hideSplash = function() {
        const splash = document.getElementById('splash-screen');
        if(splash) {
            if(progressEl) progressEl.style.width = '100%';
            if(msgEl) msgEl.textContent = 'Welcome back!';
            setTimeout(() => {
        ...
        } else if(_origHideSplash) _origHideSplash();
    };
})();
